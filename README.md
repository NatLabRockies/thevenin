...
[![ci-tests](https://github.com/NatLabRockies/thevenin/actions/workflows/ci.yml/badge.svg)](https://github.com/NatLabRockies/thevenin/actions/workflows/ci.yml) &nbsp;
...
[![conda-downloads](https://img.shields.io/conda/d/conda-forge/thevenin)](https://anaconda.org/channels/conda-forge/packages/thevenin/overview) <br>
[![pypi](https://img.shields.io/pypi/v/thevenin)](https://pypi.org/project/thevenin) &nbsp;
[![pypi-downloads](https://static.pepy.tech/personalized-badge/thevenin?period=total&units=INTERNATIONAL_SYSTEM&left_color=GREY&right_color=BRIGHTGREEN&left_text=pypi|downloads)](https://pepy.tech/projects/thevenin) 
